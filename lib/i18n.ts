...
const DICT = {
  fr: {
    ...
    nav_graph: 'Graphe de connaissance', nav_evidence: 'Evidences',
    nav_datasets: 'Jeux de données', nav_analytics: 'Analytique', nav_about: 'À propos',
    nav_bientot: 'bientôt',
  ...
  en: {
    ...
    nav_graph: 'Knowledge Graph', nav_evidence: 'Evidence',
    nav_datasets: 'Datasets', nav_analytics: 'Analytics', nav_about: 'About',
    nav_bientot: 'soon',
