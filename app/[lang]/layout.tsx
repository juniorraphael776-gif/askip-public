    ...
    <div className="min-h-screen">
      ...
      <nav className="border-b" style={{ borderColor: LINE, background: PAPER }}>
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-x-6 gap-y-3 px-5 py-3">
          ...
          {/* La barre est le SEUL composant client du gabarit : elle a besoin de
              l'adresse courante pour marquer l'onglet actif. Voir `app/nav.tsx` —
              notamment pourquoi `/burden` allume « Analytique » et `/gaps` allume
              « Défis connus ». */}
          <Nav lang={L} />
